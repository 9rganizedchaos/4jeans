...
const verticalPhotoProps = {
  imgUrl: "https://images.unsplash.com/photo-1669137980057-379be721806c?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=MnwzODMyODh8MHwxfGFsbHwyfHx8fHx8Mnx8MTY2OTM3MzI3NA&ixlib=rb-4.0.3&q=80&w=1080",
  altText: "",
...
const horizontalPhotoProps = {
  imgUrl: "https://images.unsplash.com/photo-1669234447681-1f9cdeaf7071?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=MnwzODMyODh8MHwxfGFsbHwzfHx8fHx8Mnx8MTY2OTM3MzI3NA&ixlib=rb-4.0.3&q=80&w=1080",
  altText: "Lost in the orange.",
  profileUrl: "https://images.unsplash.com/profile-1604758536753-68fd6f23aaf7image?ixlib=rb-4.0.3&crop=faces&fit=crop&w=128&h=128",
